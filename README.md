...
LLRT now includes a proof-of-concept WebAssembly bridge backed by [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime), exported as `llrt-WebAssembly.so` or `llrt-WebAssembly.dll`.
